...
def load_data(dirname):
    ...
    return x_train[0:450],y_train[0:450],x_train[451:-1],y_train[451:-1]


def simple_rnn():
    model = Sequential()
    model.add(SimpleRNN(units=64, input_shape=(150, 42)))
...
def rnn_lstm():
    model = Sequential()
    model.add(layers.LSTM(64,return_sequences=True,input_shape=(150,42)))  # returns a sequence of vectors of dimension 32
...
def bidirectional_lstm():
    model = Sequential()
    model.add(Bidirectional(layers.LSTM(64, return_sequences=True), input_shape=(150, 42)))
...
if __name__=='__main__':
    main("/Users/jongwook/Desktop/traininput/")
