...
def start():
    ...
    os.system("cd src/ && CL_TARGET_OPENCL_VERSION=300 &&  bazel build -c opt --copt -DMESA_EGL_NO_X11_HEADERS app:files_to_csv_gpu")
    input_dir = "/home/signlang/Videos/input_SignDict/"
...
def doConversion(filename):
    ...
    --output_video_path=/home/signlang/Videos/output_SignDict/")
