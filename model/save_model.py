...
def rnn_lstm():
    model = Sequential()
    model.add(layers.LSTM(64,return_sequences=True,input_shape=(260,42)))  # returns a sequence of vectors of dimension 32
...
def bidirectional_lstm():
    model = Sequential()
    model.add(Bidirectional(layers.LSTM(64, return_sequences=True), input_shape=(260, 42)))
...
def main(dirname):
    (x_train,y_train)=load_data(dirname)
