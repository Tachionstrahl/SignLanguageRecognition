...
def start():
    ...
    os.system("CL_TARGET_OPENCL_VERSION=300 &&  bazel build -c opt --copt -DMESA_EGL_NO_X11_HEADERS app:files_to_csv_gpu")
...
def doConversion(filename):
    result = os.system("GLOG_logtostderr=1 bazel-bin/app/files_to_csv_gpu \
    --calculator_graph_config_file=graphs/video_processing_gpu.pbtxt \
    --input_video_path="+ filename + " \
    --output_video_path=/home/signlang/Videos/output_reduced/")
